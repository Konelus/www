...
<?php
    ...
    if (isset ($_POST['confirm']))
    {
        ...
        if      (strpos($output_port_status_8, '=1')) { $port_status_8 = 'success'; }
        else if (strpos($output_port_status_8, '=2 ') || strpos($output_port_status_8, 'недоступно')) { $port_status_8 = 'danger'; }
    ...
    <body>
        ...
        <table class = 'table'>
            ...
            <tr class = '<?php echo $ping_gateway ?>'>
                <td style = 'width: 200px; border-right: solid 1px lightgrey;'><?php echo "Шлюз<br> {$uik_monitoring['ip_shlyuza']}" ?></td>
            ...
            <tr>
                <td  class = '<?php echo $cam2 ?>' rowspan = '2' style = 'width: 200px; border-right: solid 1px lightgrey;'><?php echo "Камера 2<br>RID: {$uik_monitoring['rid_obekta']}<br>{$uik_monitoring['ip_adres_cam2']}" ?></td>
            ...
            <tr class = '<?php echo $ping_controller ?>' style = 'border: solid 1px lightgrey;'>
                <td style = 'width: 200px; border-right: solid 1px lightgrey;'><?php echo "Контроллер<br>{$uik_monitoring['ip_adres_kontrollera']}" ?></td>
                <td style = 'width: 200px; border-right: solid 1px lightgrey;'>Ping</td>

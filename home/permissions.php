...
<form method = 'post'>
    ...
    <?php if ((isset ($_POST['edit_users_permissions'])) || (isset ($_POST['confirm'])))
    {
        ...
        //$group = $_POST['group'];
        ?>
            <script>$('input[name = "table_name"]').val("<?php echo $selected_table_name ?>");</script>
            <script>$('input[name = "table_description"]').val("<?php echo $selected_table_description ?>");</script>
            <script>$('input[name = "group"]').val("<?php echo $_POST['group_for_edit'] ?>");</script>

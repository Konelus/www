    ...
    <div class = 'row' style= 'margin-right: 0;'>
        <div class = 'row main_header'>
            ...
            <div class = 'col-lg-6 col-md-4 col-sm-4'>
                ...
                <?php } else { ?><div style = 'font-size: 22px; text-align: center; margin-top: 15px;'>Список доступных проектов:</div><?php } ?>
            </div>
    ...
    <div class = 'row'>
        <div class = 'col-lg-12 col-md-12 col-sm-12' style = 'padding-left: 0; padding-right: 0;'>
            ...
            <div class = 'col-lg-8 col-md-8 col-sm-8' style ='padding-left: 0; padding-right: 0;'>
                <?php if ($substring == '') { require_once ($_SERVER['DOCUMENT_ROOT']."/home/pages/main.php"); } ?>
            </div>
